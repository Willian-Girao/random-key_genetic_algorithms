...
class Population {
  public:
    ...
    void mateIndividuals(Instance *inst, double muleVelocity, string ls, int rvndMax); /* Produces offsprings of solutions - 'popSize' even 25% of population | 'popSize' odd 20% of population */
    void sequentialConstructiveCrossover(Instance *inst, double muleVelocity, string ls, int rvndMax, string mating); /* Produces offsprings of solutions - 'popSize' even 25% of population | 'popSize' odd 20% of population */
